...
/* ==========================================================================
   LISTS (events, news)
   ========================================================================== */
.controller('ListsController', ['$scope', '$routeParams', '$location', 'AppStaticFactory', 'SectionService', 'ListFactory',
...
function($scope, $routeParams, $location, $filter, AppStaticFactory, SectionService, entries) {
	...
	$scope.filteredEntries = $filter('filter')($scope.entries, $scope.section.listFilter);
...
/* ==========================================================================
   ARTICLE
   ========================================================================== */
.controller('ArticleController', ['$scope', '$routeParams', '$location', '$filter', 'AppStaticFactory', 'article',
function($scope, $routeParams, $location, $filter, AppStaticFactory, article) {
	//vars
...
/* ==========================================================================
   PAGE
   ========================================================================== */
.controller('PageController', ['$scope', '$routeParams', '$location', '$filter', 'AppStaticFactory', 'page',
function($scope, $routeParams, $location, $filter, AppStaticFactory, page) {
	//vars
