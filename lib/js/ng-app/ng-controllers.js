...
function($scope, $routeParams, $location, $filter, AppStaticFactory, SectionService, article) {
	...
	//fake data for dev until ET fixes issues
	$scope.section.article.location = "Melbourne";
    $scope.section.article.cost = "$125 per person";
	$scope.section.article.contact = "contact@msa.com.au";
	$scope.section.article.events = [
		{
			"d": "24",
			"m": "Feb",
			"location": "Melbourne",
