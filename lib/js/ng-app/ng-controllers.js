...
/* ==========================================================================
   ...
   ========================================================================== */
.controller('ListController', ['$scope', '$routeParams', '$location', '$filter', 'AppStaticFactory', 'SectionService', 'ListFactory',
function($scope, $routeParams, $location, $filter, AppStaticFactory, SectionService, ListFactory) {
	//vars
	var showAll = AppStaticFactory.strShowAll,
	...
	//list entries
	$scope.entries = ListFactory['query_' + $scope.section.id]();
